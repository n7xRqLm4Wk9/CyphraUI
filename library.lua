...
function Luxware:CreateWindow(options)
    ...
    OpenBtn.InputBegan:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
            ...
            -- Lock onto the release event immediately
    ...
    -- Globally track the movement so it never drops
    UserInputService.InputChanged:Connect(function(input)
    ...
    local function BuildElementsAPI(TargetParent, IsNested)
        ...
        -- // Interactive HSV Color Picker (Fixed Spectrums & White Indicators)
        function API:CreateColorPicker(opts)
            ...
            -- Solid White Cursor w/ Black Outline for mobile visibility
            ...
            -- Solid White Circle Cursor w/ Black Outline for mobile visibility
