...
function CyphraUI:CreateWindow(settings)
	...
	-- Control Panel Actions Layout (Prevents cutoff bug)
	...
	function windowObj:CreateTab(name)
		...
		function tabObj:CreateDropdown(settings)
			...
			-- Fixed Option Grid Container (Supports seamless vertical scrolling list arrays)
			...
			-- FIX: Elements parent correctly inside the list variable grid space now
