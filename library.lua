...
-- // Global Window/Topbar Dragging Logic
...
function Luxware:CreateWindow(options)
    ...
    -- ============================================================================
    -- REWORKED BULLETPROOF MOBILE/PC DRAG & CLICK LOGIC FOR LW BUTTON
    -- ============================================================================
    ...
    local function BuildElementsAPI(TargetParent, IsNested)
        ...
        -- // Interactive HSV Color Picker (Fixed Spectrums)
        function API:CreateColorPicker(opts)
            ...
            local function UpdateHue(input)
                ...
                h = percent -- Fixed: Removed '1 - percent' inversion loop
                UpdateColor()
            end
            ...
            function opts:Set(color)
                opts.Color = color
                h, s, v = color:ToHSV()
                HueCursor.Position = UDim2.new(h, 0, 0.5, 0) -- Match exact coordinate spectrum positioning
